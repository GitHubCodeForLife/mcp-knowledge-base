# multi-hop-query-support Specification

## Purpose

MCP-facing support for more complicated questions: multi-query retrieval in one round trip and optional path-based scope filters, without running an answer model inside the server.
